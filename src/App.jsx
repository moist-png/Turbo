...
function HomeView({ account, ftpHistory, workoutHistory, trainingPlan, onNavigate, onPlayGame }) {
  ...
  const heroes = [
    ...
    { key: 'planner', label: 'Planner', caption: plannerCaption, icon: CalendarDays, photo: '/images/home-planner.jpg', surface: 'var(--hero3)', photoPos: '35% 25%', ink: 'var(--hero3-ink)', chip: 'var(--hero3-chip)' },
