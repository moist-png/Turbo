      ...
      <OrientationGate preferredOrientation={settings.preferredOrientation}>
        <div style={isSidebar ? { display: 'flex', height: '100dvh', overflow: 'hidden' } : undefined}>
          ...
          >
            ...
            {view === 'planner' && <PlannerView plan={trainingPlan} ftp={ftp} recentWeeklyTss={recentWeeklyTss} library={LIBRARY} workoutHistory={workoutHistory} ftpHistory={ftpHistory} onSavePlan={saveTrainingPlan} onOpenPlanWorkout={openPlanWorkout} archivedPlans={archivedPlans} onArchivePlan={archivePlan} onDeleteArchivedPlan={deleteArchivedPlan} onLogOutdoor={logOutdoorRide} />}
